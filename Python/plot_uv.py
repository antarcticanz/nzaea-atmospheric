...
def plot_daily_uvi(
    ...
    *,
    ...
    """
    Plot Sep 1 → Mar 31 climatology of Daily Maximum UVI with shaded variability.
    ...
    end_date = pd.Timestamp(2001, 3, 31)
...
def plot_daily_uv(
    ...
    *,
    ...
    """
    Plot Sep 1 → Mar 31 climatology of Daily Maximum UVA (left axis) and
